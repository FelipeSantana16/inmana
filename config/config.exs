...
# Configurando um adaptador para envio de emails apenas localmente com o Plugin Bamboo
config :inmana, Inmana.Mailer, adapter: Bamboo.LocalAdapter

# Configures the endpoint
config :inmana, InmanaWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "mKjH8/HHGC/qqFemwwc7w8ztRDVQs2XlKGjbDmhKYfyZ677ZeLEEGh3Q3egCliol",
  render_errors: [view: InmanaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Inmana.PubSub,
  live_view: [signing_salt: "A5hUErR8"]
